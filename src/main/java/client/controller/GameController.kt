...
class GameController {
    ...
    private fun handleMessage(payload: Payload) {
        ...
        when (payload) {
            ...
            is proto.dto.GameState -> handleGameState(payload)
    ...
    private fun handleGameState(newState: proto.dto.GameState) {
    ...
    fun getCurrentGameState(): proto.dto.GameState? = gameStateModel.gameState
